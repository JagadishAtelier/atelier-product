...
` +
    ...
    Ni.define(
      ...
      (Gs.exports = function (e, t, r) {
        ...
        function C(R) {
          return R.indexOf("//") >= 0
            ? R
            : S("https://editor-api.webflow.com" + R);
        }
        function S(R) {
  ...
  var wl = u((BH, xl) => {
    ...
    xl.exports =
      ...
      function (t, r) {
        ...
        return (
          t !== null
            ? ((yo[mo] = oO(t)), (n = new yo()), (yo[mo] = null), (n[Sl] = t))
            : (n = En()),
          r === void 0 ? n : aO(n, r)
        );
      };
  ...
  var He,
    ...
    Uo = ce(() => {
      ...
      (He = {
        ...
        (NS = { X_AXIS: "X_AXIS", Y_AXIS: "Y_AXIS" }),
        (LS = {
          CHILDREN: "CHILDREN",
          SIBLINGS: "SIBLINGS",
  ...
  var BS,
    ...
    yf = ce(() => {
      "use strict";
      (BS = "IX2_RAW_DATA_IMPORTED"),
        (WS = "IX2_SESSION_INITIALIZED"),
        (kS = "IX2_SESSION_STARTED"),
        (jS = "IX2_SESSION_STOPPED"),
        (zS = "IX2_PREVIEW_REQUESTED"),
        (KS = "IX2_PLAYBACK_REQUESTED"),
        ($S = "IX2_STOP_REQUESTED"),
        (YS = "IX2_CLEAR_REQUESTED"),
        (QS = "IX2_EVENT_LISTENER_ADDED"),
        (ZS = "IX2_EVENT_STATE_CHANGED"),
        (JS = "IX2_ANIMATION_FRAME_CHANGED"),
  ...
  var Gg = u((iW, Fg) => {
    ...
    function RN(e, t, r, n, i, o) {
      ...
      if (g && !p)
        return (
          o || (o = new aa()),
          a || AN(e) ? bN(e, t, r, n, i, o) : ON(e, t, c, r, n, i, o)
        );
      if (!(r & xN)) {
  ...
  var Oa,
    ...
    Ca = ce(() => {
      ...
      (At = (e) => (t) => {
        ...
        (Sa = At("getPluginConfig")),
        (Aa = At("getPluginOrigin")),
        (bM = At("getPluginDuration")),
        (xa = At("getPluginDestination")),
        (OM = At("createPluginInstance")),
        (wa = At("renderPlugin")),
        (Ra = At("clearPlugin"));
    });
  var Eh = u((QW, hh) => {
  ...
  function S1({ store: e, select: t, onChange: r, comparator: n = O1 }) {
  ...
  function Ga({
    ...
    if (
      (G
        ...
        : (H = k = s({ id: m, selector: S, selectorGuids: A })),
      t && R)
    ) {
      let P = r && (k || R === !0) ? [r] : c(Q);
      if (k) {
    ...
    iE = ce(() => {
      ...
      (ni = ie(wt())),
        ...
        (bD = (e, t) => {
          ...
          return (0, st.merge)(e, { position: S, current: G });
        }),
        (OD = (e, t) => {
          let {
              active: r,
            ...
            handler: (
              ...
              switch (a) {
                ...
                case Ze.PAGE: {
                  ...
                  S = m ? Math.min(R + h, x) / x : Math.min(w + E, G) / G;
                  break;
                }
                case Ze.ELEMENT:
                default: {
              ...
              return (
                C && (S > 1 - Gm || S < Gm) && (S = Math.round(S)),
                (a !== Ze.ELEMENT || O || O !== o.elementHovered) &&
                  ((S = f ? 1 - S : S), e.dispatch(ir(A, S))),
                {
                  elementHovered: O,
                  clientX: d,
                  clientY: g,
    ...
    (0, sr.default)(s, (d, g) => {
      ...
      VU(C, o.mediaQueryKeys) || t.dispatch(ts()),
        E.actionTypeId === Ce.GENERAL_CONTINUOUS_ACTION &&
          (Array.isArray(h.config) ? h.config : [h.config]).forEach((O) => {
            let { continuousParameterGroupId: R } = O,
              w = (0, ut.default)(a, `${S}.continuousParameterGroups`, []),
        ...
        (E.actionTypeId === Ce.GENERAL_START_ACTION || vs(E.actionTypeId)) &&
          d_({ store: t, actionListId: S, eventId: m });
    });
    let c = (d) => {
        ...
        aX(s, (h, E, m) => {
          let C = r[E],
            S = g.eventState[m],
            { action: A, mediaQueries: O = o.mediaQueryKeys } = C;
    ...
    if (c && c.useFirstGroupAsInitialState) {
      ...
      f.forEach((d) => {
        ...
        m.forEach((S) => {
          ...
          ms({
            destination: Es({ element: S, actionItem: d, elementApi: xe }, A),
            immediate: !0,
            store: e,
            element: S,
            eventId: r,
    ...
    if (mi(G, R.mediaQueryKey) && (n || r || i)) {
      ...
      if (i) {
        if (m) {
          ...
          S && !X && t.dispatch(or({ actionListId: E, isPlaying: !1 }));
        }
        _s(e, t);
      }
    }
      ...
      (x_.exports = function (e) {
        ...
        function n(o) {
          ...
          function d(C) {
            ...
            (S && S.length > 1) ||
              ((a = !0),
              S ? ((s = !0), (f = S[0].clientX)) : (f = C.clientX),
              (p = f));
          }
          function g(C) {
            if (a) {
  ...
  events: {
    ...
    "e-7": {
      ...
      target: {
        ...
        originalId:
          "65cc742940cb3798ef9ade48|aa36392c-63e8-8612-bc90-7e773528bcd4",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-11": {
      ...
      target: {
        selector: ".big-banner",
        originalId:
          "65cc742940cb3798ef9ade48|fb486b95-3aac-fe6d-e64b-874779f16e3c",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-13": {
      ...
      target: {
        ...
        originalId:
          "65cc742940cb3798ef9ade48|1a1e278b-851a-0158-98a2-9374a64a89dc",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-15": {
      ...
      target: {
        ...
        originalId:
          "65cc742940cb3798ef9ade48|10a2f923-4f5c-3703-4732-215b679a9b9b",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-17": {
      ...
      target: {
        ...
        originalId:
          "65cc742940cb3798ef9ade48|23411bdd-c2c8-4362-099d-7aa99240dd49",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-19": {
      ...
      target: {
        ...
        originalId:
          "65cc742940cb3798ef9ade48|ba46b409-53ff-dd95-1954-1a41b1fbaf1f",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-21": {
      ...
      target: {
        ...
        originalId:
          "65cc742940cb3798ef9ade48|133735e5-fca4-3a09-b651-44e4a166f8e2",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-25": {
      ...
      target: {
        ...
        originalId:
          "65cc742940cb3798ef9ade48|b70bd833-e217-7288-ac96-bbc3487eac63",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-27": {
      ...
      target: {
        ...
        originalId:
          "65cc742940cb3798ef9ade48|cf3310f1-53ec-1352-9678-9b4ff5a5a046",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-29": {
      ...
      target: {
        selector: ".form-image",
        originalId:
          "65cc742940cb3798ef9ade48|f5e84e0f-b12f-36f2-2f52-ac4e499e9216",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-31": {
      ...
      target: {
        ...
        originalId:
          "65cc742940cb3798ef9ade48|8fbe4c36-9033-27a5-8c1c-1fede981416b",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-33": {
      ...
      target: {
        ...
        originalId:
          "65cc742940cb3798ef9ade48|3990fbf9-d1f6-1215-6bb2-0f9393377cda",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-35": {
      ...
      target: {
        ...
        originalId:
          "65cc742940cb3798ef9ade48|8e34488c-6509-e62c-7dd9-7d6f18f92bac",
        appliesTo: "CLASS",
      },
      targets: [
        {
